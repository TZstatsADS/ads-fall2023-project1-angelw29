...
word <- c("happy","ago","yesterday","lot","today","months","month",
                 "happier","happiest","last","week","past","time", "moment","day",
          "havent", "hadnt")
...
```{r export data}
write_csv(hm_data, "/Users/angelwang/Desktop/fall 2023/4243/ads-fall2023-project1-angelw29/output/processed_moments.csv")
```
